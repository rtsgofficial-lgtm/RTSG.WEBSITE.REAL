...
export const GLOBE_PROFILES: GlobeProfile[] = [
  {
    ...
    researchUrl: "https://media.rtsg.org/p/the-end-of-modenity-heidegger-and",
    description:
  ...
  },
  {
    ...
    researchUrl: "https://media.rtsg.org/p/how-china-beats-the-west-in-its-own",
    description:
  ...
  },
  {
    ...
    researchUrl: "https://media.rtsg.org/p/the-political-economy-of-barbarism",
    description:
